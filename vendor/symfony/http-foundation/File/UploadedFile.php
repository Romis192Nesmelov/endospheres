...
class UploadedFile extends File
{
    ...
    public function resizeImage($width, $height, $fileName = null, $directory = '/images/')
    {
        $fileName = $fileName ? $fileName : $directory.$this->generateImgName();
        $im = new Imagick();

        $im->pingImage($this->getPathname());
        $im->readImage($this->getPathname());
