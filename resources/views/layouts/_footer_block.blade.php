@if (isset($data['chapter']) && ($data['chapter']->id == 1 || $data['chapter']->id == 11))
    <div class="container">
...
<div id="copyright-line">
    <div class="container">
        ...
        <div class="pull-right">
            ...
            <div class="soc-icon"><a href="https://t.me/addlist/1dpLhhHPgWk1MGYy"><img src="{{ asset('images/telegram.png') }}" /></a></div>
