...
return [
    ...
    */
    ...
    'failed' => 'Не<nobr>верный логин или пароль.',
    'throttle' => 'Слишком много попыток. Пожалуйста, попробуйте через :seconds секунд.',
    'register_subj' => 'Подтверждение регистрации на сайте frenzyshirt.ru',
    ...
    'reset_password' => 'Кликните сюда для восставновления пароля:',
    'reset_password_head' => 'Сброс пароля',
    ...
    'login_head' => 'Пожалуйста, войдите, используя<br>свой E-mail и пароль.',
    'register_head' => 'Пожалуйста, заполните все поля.',
    ...
    'keep_password' => 'Если вы не хотите менять свой пароль, то оставте поля «Пароль» и «Повтор пароля» не заполненными',
